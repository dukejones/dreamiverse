 ...
 */
qq.AvatarUploaderBasic = function(o){
    this._options = {
...
qq.AvatarUploaderBasic.prototype = {
 ...
 * @inherits qq.AvatarUploaderBasic
 */
qq.AvatarUploader = function(o){
    // call parent constructor
    qq.AvatarUploaderBasic.apply(this, arguments);
    ...
    qq.extend(this._options, {
        ...
        template: '<div id="avatarDropContainer" class="qq-upload-drop-area"><div class="text">drag new image here</div><div class="browse"><div class="cancel">cancel</div><div class="dropboxBrowse">browse</div></div></div>',
        //template: '<div class="qq-upload-drop-area"><img src="/images/icons/green-plus-20.png">drag files here</div>',
    ...
    this._setupDragDrop();
    $.publish('uploader:created', [this])
};

// inherit from Basic Uploader
qq.extend(qq.AvatarUploader.prototype, qq.AvatarUploaderBasic.prototype);

qq.extend(qq.AvatarUploader.prototype, {
    /**
    ...
    _find: function(parent, type){                                
        ...
        if (!element){
            throw new Error(parent.id + ' element not found ' + type);
        }
    ...
    _onSubmit: function(id, fileName){
        if($('#IB_current_genre').text() != 'Choose'){
          qq.AvatarUploaderBasic.prototype._onSubmit.apply(this, arguments);
    ...
    _onProgress: function(id, fileName, loaded, total){
        qq.AvatarUploaderBasic.prototype._onProgress.apply(this, arguments);
...
qq.UploadHandlerAbstract.prototype = {
    log: function(str){
        if (this._options.debug && window.console) log('[uploader] ' + str);
    },
    /**
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _upload: function(id, params){
        ...
        // todo scott :: set the params by getting the params on the
        // UI so far
