...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result){
        ...
        // Add image      
        var newNode = '<div class="entryImageContainer" data-id=":image_id"><div style="background: url(&quot;:image_url&quot;) no-repeat scroll center center transparent;" class="entryImage"><div class="close-22"></div><label class="radio"><input type="radio" value=":image_id" name="entry[main_image_id]"><span>default</span></label><div class="radioWrap"></div></div></div>'
