...
qq.FileUploader = function(o){
    ...
    '<div id="IB_dropboxImagesWrap" class="dropBoxArea dark C-soft">'+
      ...
      '</ul>'+
    '</div>',*/
        template: '<div class="dropboxBrowse qq-upload-drop-area"></div><div class="clickToBrowse"><img src="/images/icons/green-plus-20.png"><span>click to browse, or drag files here</span></div>',
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result){
        ...
        var elementHtml = '<div style="background: url(&quot;'+result.image_url+'&quot;) no-repeat center center transparent;" class="entryImage"><div class="close"></div><label class="radio"><input type="radio" value=":image_id" name="entry[main_image_id]"><span>default</span></label><div class="radioWrap"></div></div>';
        ...
        $('#currentImages').append(newHiddenForm);
        $('#currentImages').slideDown();
        uploadCount--;
        if (uploadCount == 0) {
