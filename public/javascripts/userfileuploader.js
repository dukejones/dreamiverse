...
qq.FileUploader = function(o){
    ...
    '<div id="IB_dropboxImagesWrap" class="dropBoxArea dark C-soft">'+
      ...
      '</ul>'+
    '</div>',*/
        template: '<div class="dropboxBrowse">browse</div><div class="qq-upload-drop-area"><img src="/images/icons/green-plus-20.png">drag files here</div>',
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result){
        ...
        var newNode = '<div class="entryImageContainer" data-id=":image_id"><div style="background: url(&quot;:image_url&quot;) no-repeat scroll center center transparent;" class="entryImage"><div class="imageRemoveButton"></div><label class="radio"><input type="radio" name="default"><span>default</span></label><div class="radioWrap"></div></div></div>'
